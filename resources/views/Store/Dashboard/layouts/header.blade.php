<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <div class="menu-toggler sidebar-toggler" onclick="myFunction()">
                <span></span>
            </div>
        </div>
        <!-- END LOGO -->
        ...
        <div class="top-menu pull-left">
            <ul class="nav navbar-nav pull-left">
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/dashboard/layouts/layout3/img/avatar2.jpg') }}"
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/dashboard/layouts/layout3/img/avatar3.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/dashboard/layouts/layout3/img/avatar1.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                ...
                <!-- END TODO DROPDOWN -->
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar"
                    style="background-color: #2B2E45">
                    {{-- <a href="{{asset('/changeLanguagee/'.Session::get('lang'))}}" style="background-color: #2B2E45"  class="" data-hover="dropdown" data-close-others="true">
                        <i class="icon-bell"></i>
                         <span class="badge badge-primary"> {{__('dashboard.lang')}} </span>
                     </a> --}}
                </li>
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                        data-close-others="true">
                        <img alt="" class="img-circle" src="{!! Auth::guard('store')->user()->logo !!}" />
                        {{-- <img alt="" class="img-circle" src="" /> --}}
                        {{-- {{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->image }} --}}
                        <span class="username username-hide-on-mobile"> {!! Auth::guard('store')->user()->username !!} </span>
                        {{-- {{ \Illuminate\Support\Facades\Auth::guard('admin')->user()->name }} --}}
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="{{ route('store.dashboard.profile', [app()->getLocale()]) }}">
                                {{-- {{route('admin.profile')}} --}}
                                <i class="icon-user"></i> حسابي </a>
                        </li>
                        <li class="divider"> </li>
                        <li>
                            <a href="{{ route('storeLogout', [app()->getLocale()]) }}">
                                {{-- {{route('storeLogout')}} --}}
