    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{ route('store.invoiceorderlink.index', [app()->getLocale()]) }}">روابط طلبات الإيصالات</a>
                </li>
            </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="caption">
                            <a href="{{ route('store.invoiceorderlink.create',[app()->getLocale(),0]) }}" class="btn btn-primary"><i
                                    ...
                                    @foreach ($records as $key => $record)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('store.invoiceorderlink.show',[app()->getLocale(),$record->id]) }}"
                                                    class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>

                                               
                                                <a href="{{ route('store.invoiceorderlink.edit',[app()->getLocale(),$record->id]) }}"
                                                    class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>

                                                <form id="delete-form-{{ $record->id }}"
                                                    action="{{ route('store.invoiceorderlink.destroy',[app()->getLocale(),$record->id]) }}"
...
@section('myjsfile')
    <script>
        function update_status(el) {
            ...
            $.post('{{ route('store.invoiceorderlink.status', isset($record) ? [app()->getLocale(),$record->id] : '') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
