    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb pull-right">
                ...
                <li>
                    <span>تعديل طلب ايصال</span>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">نموذج تعديل طلب ايصال
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <form id="form_sample_1" class="form-horizontal"
                            action="{{ route('admin.invoiceorder.update',[app()->getLocale(),$recordtoedit->id]) }}" method="post"
                                ...
                                <div class="form-actions text-center">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{ route('admin.invoiceorder.index',[app()->getLocale()]) }}" type="button"
