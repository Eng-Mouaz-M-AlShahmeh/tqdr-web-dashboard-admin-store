            ...
            <ul class="nav navbar-nav pull-left">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                        ...
                        <img alt="" class="img-circle" src="{!! Auth::guard('admin')->user()->getImageAttribute(Auth::guard('admin')->user()->avatar) !!}" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="{{ route('admin.dashboard.profile',app()->getLocale()) }}">
                                {{-- {{route('admin.profile')}} --}}
                        ...
                        <li>
                            <a href="{{ route('adminLogout',app()->getLocale()) }}">
                                {{-- {{route('logout')}} --}}
