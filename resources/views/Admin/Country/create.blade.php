...
@section('content')
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">نموذج إضافة بلد
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form id="form_sample_1" class="form-horizontal" action="{{ route('admin.country.store',app()->getLocale()) }}"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="phone_code" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="iso_2code" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="iso_3code" data-required="1" class="form-control" />
                                    </div>
