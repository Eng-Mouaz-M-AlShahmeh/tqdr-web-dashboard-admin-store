...
@section('content')
    <div class="page-content">
        ...
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">نموذج إضافة مدينة
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form id="form_sample_1" class="form-horizontal" action="{{ route('admin.city.store',app()->getLocale()) }}"
                                ...
                                <div class="form-actions text-center">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{ route('admin.city.index',app()->getLocale()) }}" type="button"
