...
@section('title', 'تعديل مزود الخدمة')
...
@section('content')
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">نموذج تعديل مزود الخدمة
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <form id="form_sample_1" class="form-horizontal"
                            action="{{ route('admin.serviceprovider.update', [app()->getLocale(),$recordtoedit->id]) }}" method="post"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $recordtoedit->storeName }}" name="storeName" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $recordtoedit->nighborhood }}" name="nighborhood" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $recordtoedit->locationURL }}"  name="locationURL" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="tqdr_service_price"
                                            value="{{ $recordtoedit->tqdr_service_price }}" data-required="1"
                                            class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="tqdr_service_vat_percentage"
                                            value="{{ $recordtoedit->tqdr_service_vat_percentage }}" data-required="1"
                                            class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="profit_percentage"
                                            value="{{ $recordtoedit->profit_percentage }}" data-required="1"
                                            class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="profit_fixed_amount"
                                            value="{{ $recordtoedit->profit_fixed_amount }}" data-required="1"
                                            class="form-control" />
                                    </div>
