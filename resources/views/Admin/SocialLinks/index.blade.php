...
@section('content')
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> قائمة وسائل التواصل الاجتماعي
        </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <a href="{{ route('admin.sociallinks.create',[app()->getLocale(),0]) }}" class="btn btn-primary"><i
                                    ...
                                    @foreach ($records as $key => $record)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.sociallinks.show',[app()->getLocale(),$record->id]) }}"
                                                    class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>

                                                <a href="{{ route('admin.sociallinks.edit',[app()->getLocale(),$record->id]) }}"
                                                    class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>

                                                <form id="delete-form-{{ $record->id }}"
                                                    action="{{ route('admin.sociallinks.destroy',[app()->getLocale(), $record->id]) }}"
