...
@section('content')
    <div class="page-content">
        ...
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">نموذج تعديل العنوان
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <form id="form_sample_1" class="form-horizontal"
                            action="{{ route('admin.address.update', [app()->getLocale(),$recordtoedit->id]) }}" method="post"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" value="{{ $recordtoedit->building_number }}"
                                            name="building_number" data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="{{ $recordtoedit->street_name }}" name="street_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" value="{{ $recordtoedit->postal_code }}" name="postal_code"
                                            data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" value="{{ $recordtoedit->longitude }}" name="longitude"
                                            data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" value="{{ $recordtoedit->latitude }}" name="latitude"
                                            data-required="1" class="form-control" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" value="{{ $recordtoedit->zoom }}" name="zoom"
                                            data-required="1" class="form-control" />
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="city_id" id="city_id">
                                            @foreach ($cities as $city)
                                                <option {{ $city->id == $recordtoedit->city_id ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="nighborhood_id" id="nighborhood_id">
                                            @foreach ($nighborhoods as $nighborhood)
                                                <option
                                                    {{ $nighborhood->id == $recordtoedit->nighborhood_id ? 'selected' : '' }}
                                                    value="{{ $nighborhood->id }}">{{ $nighborhood->name }}</option>
                                            @endforeach
                                        </select>
