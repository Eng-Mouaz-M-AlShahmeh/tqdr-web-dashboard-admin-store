<div>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <h2 class="text-center"
                    style="color: white; margin-top: 100px; margin-bottom: 20px; font-size: 15px">{{ __('translate.MobileNumber') }}</h2>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <h2 class="text-center"
                    ...
                    <select wire:model="store" id="store" class="form-control">
                        ...
                        <option value="">{{ __('translate.SelectStore') }}</option>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <h2 class="text-center"
                    style="color: white; margin-top: 100px; margin-bottom: 20px; font-size: 15px">{{ __('translate.Amount') }}</h2>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <h2 class="text-center"
                    style="color: white; margin-top: 100px; margin-bottom: 20px; font-size: 15px">{{ __('translate.OrderNumber') }}</h2>
            ...
            <div style="margin-top: 100px; margin-bottom: 50px;" class="col-md-12 col-lg-12 col-sm-12">
                ...
                <button class="p-5 btn btn-warning" wire:click.prevent="pay()" wire:loading.attr="disabled">
                    {{ __('translate.Send') }}
                </button>
